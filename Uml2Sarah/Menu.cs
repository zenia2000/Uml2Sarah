...
namespace Uml2Sarah
{
    public class Menu
    {
        ...
        {
            Console.WriteLine("\tAdd a Pizza to menu");
            Console.Write("\tType name of pizza: ");
            string pizzaName = Console.ReadLine();
            Console.Write("\tType the toppings, separate with , : ");
            string pizzaTopping = Console.ReadLine();
            Console.Write("\tType pizza number: ");
            string pizzaNo = Console.ReadLine();
            Console.Write("\tType the price. Like - 80,00: ");
            double pizzaPrice = double.Parse( Console.ReadLine());
            Pizza p = new Pizza(pizzaName,pizzaTopping,pizzaNo,pizzaPrice);
            _pizzaLibrary.AddPizza(p);
            Console.WriteLine();
            Console.WriteLine("\tYour pizza has been added to the menu");
        }
